(function () {
    ...
    Plugin.prototype.structure = function () {
        ...
        if (this.doCss()) {
            let $inner = this.$outer.find('.lg-inner');
    ...
    Plugin.prototype.setTop = function () {
        if (this.s.height !== '100%') {
            ...
            let $lGallery = this.$outer.find('.lg');
    ...
    Plugin.prototype.isVideo = function (src, index) {
        ...
        let youtube = src.match(/\/\/(?:www\.)?youtu(?:\.be|be\.com|be-nocookie\.com)\/(?:watch\?v=|embed\/)?([a-z0-9\-\_\%]+)/i);
    ...
    */
    Plugin.prototype.slide = function (index, fromTouch, fromThumb, direction) {
        ...
        let _prevIndex = this.$outer.find('.lg-current').index();
        let _this = this;
        ...
        let _time = _this.lGalleryOn ? this.s.speed : 0;
